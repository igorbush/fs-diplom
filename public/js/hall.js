$(document).ready(function() {
    ...
    $('.buying__info-hint').css('cursor', 'pointer');
    $('.buying__info-hint').on('dblclick', function() {
        if ($(this).css('display') == 'block') {
            $('.buying-scheme__chair').animate({ width: 25, height: 25 }, 300);
            $('.buying-scheme').animate({ 'zoom': 1.4 }, 300);
        };
    });
});